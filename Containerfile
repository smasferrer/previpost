...
#FROM pv1prdsat150.sistemas.previred/previred/ocp_docker_images/ubi9_nodejs-24
...
FROM pv1prdsat150.sistemas.previred/previred/ocp_docker_images/ubi8_nginx-122
...
# podman run -p 8092:8080 previpost-front